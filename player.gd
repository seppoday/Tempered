...
func _deal_damage_to_overlapping_enemies() -> void:
	...
	# WAŻNE: zamiast get_overlapping_bodies() (buforowane, opóźnione o klatkę
	# fizyki) pytamy przestrzeń fizyczną bezpośrednio, z AKTUALNĄ transformacją
	# hitboxa. Eliminuje to "duchy" trafień przy szybkich zamachach.
